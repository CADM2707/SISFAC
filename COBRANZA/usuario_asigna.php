...
if(isset($consultaBusqueda)){
	...
	if ($filas === true){ 
		...
		while($resultados = sqlsrv_fetch_array($res_usuario1)){
			...
			$mensaje .= "<td><a href='buscar_pusuario.php?usu=$usu&cont=$cont&usu_dep=$usu_dep'><input type='button' name='subep***".$resultados['ID_USUARIO']."' id='subep' value='Agregar usuario' class='btn btn-primary btn-sm center-block' /></a></td>";
			$mensaje .= "</tr>";
				$cont++;		
