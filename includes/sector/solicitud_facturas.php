			...
			$html.="				
				...
				if(($count2-1)==$a1){
					...
					<tr class='bg-danger'>
						...
						<td  align='center'  valign='middle' >$tt_fjerarquia</td>		
				...
				if(($count2-1)==$a1){			
					...
					$tt_tarifa=0; $tt_tn=0; $tt_td=0; $tt_tf=0; $tt_jerarquia=0; $tt_ftn=0; $tt_ftd=0; $tt_ftf=0; $tt_tamas=0; $tt_tame=0; $tt_taju=0;
