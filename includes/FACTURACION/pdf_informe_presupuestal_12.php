...
$sqltn_2="select [dbo].[CantidadConLetra] ($total) IMPORTE_LETRA";
		...
		$pdf->Ln(28);
		$pdf->MultiCell(190,4,utf8_decode("En cumplimiento a los artículos 50 de la Ley de Presupuesto y Gasto Eficiente del Distrito Federal
(ahora Ciudad de México) vigente y 308 del Código Fiscal de la Ciudad de México, así como a la Base
Primera de las Bases de Colaboración 'PADF/DG/1112/II/69/01/05/31975/2012', se informa de los servicios prestados por la Policía Auxiliar de la Ciudad de México, así como del importe de la C.L.C. que deberá tramitar ante la Secretaría de Finanzas con afectación a la partida 3411 dentro de los primeros 15 días naturales posteriores a cada período considerado."),0,'J');
		$pdf->SetFont('Arial','B',8);
		$pdf->Ln(10);
