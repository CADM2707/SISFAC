...
$sqltn_2="select [dbo].[CantidadConLetra] ($total) IMPORTE_LETRA";
		...
		$pdf->Ln(25);
		$pdf->MultiCell(190,4,utf8_decode("En cumplimiento al artículo 397 del Código Fiscal de la Ciudad de México, se informa de los servicios 
prestados por la Policía Auxiliar de la Ciudad de México, así como del importe de la C.L.C. que deberá 
tramitar ante la Secretaría de Finanzas con afectación a la partida 3381."),0,'J');
		$pdf->SetFont('Arial','B',8);
		$pdf->Ln(10);
